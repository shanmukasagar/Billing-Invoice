...
export const getProductActions = { //Get all products
    ...
    RESET_PRODUCTS_AUTHENTICATION : "RESET_PRODUCTS_AUTHENTICATION"
}
...
export const getTransactionActions = { //Get all transactions
    ...
    RESET_TRANSACTION_AUTHENTICATION : "RESET_TRANSACTION_AUTHENTICATION"
}

export const authenticatePageActions = {
