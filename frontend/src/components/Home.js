        ...
        <Box className = "home_main">
            ...
            <Box className = "grid_main">
                <Grid container className = "grid_parent">
                    ...
                    <Grid item xs = {1}><Typography className = "key_name">Product</Typography></Grid>
                    <Grid item xs = {3}><Typography className = "key_name key_center">User</Typography></Grid>
                ...
                </Grid>
                {
                    transactionsData.length > 0 && transactionsData.slice().reverse().map((item, index) => (
                        <Grid container className = "grid_child" key = {index}>
                            ...
                            <Grid item xs = {1}><Typography className = "value_name">{item.products.p_nm}</Typography></Grid>
                            <Grid item xs = {3}><Typography className = "value_name value_center">{item.userId}</Typography></Grid>
